...
import com.kochetov.libraryapis.libraryapis.security.SecurityConstants;
...
public class UserService {
    ...
    public void addUser(User userToBeAdded, String traceId)
        ...
        try {
            ...
            logger.error("TraceId: {}, User already exists!!", traceId, e); // if data is wrong in request json it will also throw
